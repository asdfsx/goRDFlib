...
const nt12Manifest = "../testdata/w3c/rdf-tests/rdf/rdf12/rdf-n-triples/syntax/manifest.ttl"

func TestW3CNTriples12(t *testing.T) {
	m, err := w3c.ParseManifest(nt12Manifest)
	if err != nil {
